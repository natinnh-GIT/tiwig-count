...
const FIELDS = [
  "Brand / Model", "Magnification", "Reticle Type", "Tube Diameter",
  "Mounted On (Firearm)", "Purchase Date", "Estimated Value", "Notes", "Photo"
];
  ...
  return (
    <div style={{ padding: "40px 20px", display: "flex", flexDirection: "column", alignItems: "center", gap: 20 }}>
      <div style={{ width: 64, height: 64, background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: 3, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Eye style={{ width: 32, height: 32, color: "#f97316" }} />
      </div>
      <div style={{ textAlign: "center" }}>
        <p style={{ color: "#f5f5f5", fontWeight: 700, fontSize: 16, marginBottom: 6 }}>Optics Catalog</p>
        <p style={{ color: "#a3a3a3", fontSize: 13 }}>No optics cataloged yet. Tap + to add your first.</p>
      </div>
